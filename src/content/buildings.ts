...
export const BUILDINGS: Record<string, BuildingDef> = {
  ...
  "castle": { name: "Castle", hp: 600, cost: { gold: 900, wood: 0 }, buildTime: 45, footprint: 3, foodBonus: 0, canAttack: false, attack: 0, attackSpeed: 0, range: 0, trains: ["worker"], requires: [] },
